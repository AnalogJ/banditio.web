angular.module('banditApp.controllers', [ 'banditApp.services'])
    // Nav Controller (Top bar and Left Menu)
    .controller('navCtrl', function($scope,$routeParams,$location,banditdb){
        //Global variables
        $scope.room_id = $routeParams.room_id || 'all';
    ...
    //Panel Controllers
    .controller('roomCtrl', function ($scope,$routeParams,cfpLoadingBar, banditdb) {
        $scope.room_id = $routeParams.room_id || 'all';
    ...
    .controller('resourceCtrl', function ($scope,$routeParams,cfpLoadingBar, banditdb) {
